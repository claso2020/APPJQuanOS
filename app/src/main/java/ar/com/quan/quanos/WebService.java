...
public class WebService {
    ...
    public static void modificarDatosTitulares(final Context contexto,
            ...
            final String idEstCivil,
            final String claveFiscal,
            final String cantGrupoFam,
            final String idPlanPrestacional,
            final String comentario,
            final String dtContactosDomicilio,
            final String dtContactosTelefono,
            final String dtContactosEmail,
            final String dtFamiliares,
            final String idTipoRelacionLaboral,
            final String dtRelacionesLaborales,
            final  String dtArchivosAdjuntos,
            final String cuentaVerificacionCUILTitular,
            final String noVerificarCuilTitular,
            final String origenPeticion,
            final  String idEstadoAfiliacion,
            final String perAlta,
            final String perBaja,
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (msgError.getString("valorDevuelto").equals("00")) {
                        ...
                        String msgAviso = msgError.getString("mensaje");
                        errorHandler.onError(msgAviso);
                    } else {
                        errorHandler.onError("Error al guardar datos titular:\n\tCódigo de retorno inválido");
                    }
                } catch (Exception errEx) {
                    errorHandler.onError("Error desconocido al guardar datos titular:\n\t" + errEx.getMessage());
                }
            }
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<String, String>();
                params.put("idConexion", idConexion);
                params.put("idTitular", idTitular);
                params.put("apellido", apellido);
                params.put("nombres", nombres);
                params.put("fecNac", fecNac);
                params.put("cuil", cuil);
                params.put("idSexo", idSexo);
                params.put("idNacionalidad", idNacionalidad);
                params.put("idEstCivil", idEstCivil);
                params.put("claveFiscal", claveFiscal);
                params.put("cantGrupoFam", cantGrupoFam);
                params.put("idPlanPrestacional", idPlanPrestacional);
                params.put("comentario", comentario);
                params.put("dtContactosDomicilio", dtContactosDomicilio);
                params.put("dtContactosTelefono", dtContactosTelefono);
                params.put("dtContactosEmail", dtContactosEmail);
                params.put("dtFamiliares", dtFamiliares);
                params.put("idTipoRelacionLaboral", idTipoRelacionLaboral);
                params.put("dtRelacionesLaborales", dtRelacionesLaborales);
                params.put("dtArchivosAdjuntos", dtArchivosAdjuntos);
                params.put("cuentaVerificacionCUILTitular", cuentaVerificacionCUILTitular);
                params.put("noVerificarCuilTitular", noVerificarCuilTitular);
                params.put("origenPeticion", origenPeticion);
                params.put("idEstadoAfiliacion", idEstadoAfiliacion);
                params.put("perAlta", perAlta);
                params.put("perAlta", perBaja);
